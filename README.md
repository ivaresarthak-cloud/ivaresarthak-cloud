...
### What Drives Me
- **Understanding real problems** — I use tools as a user first, find gaps, then fix them
- **Open source collaboration** — Direct engagement with maintainers, not just code submissions
- **Learning in public** — Building expertise through contributions and knowledge sharing
- **Kubernetes ecosystem** — Security, operators, observability, infrastructure automation
...
- [kubescape/kubescape#2310](https://github.com/kubescape/kubescape/pull/2310) — **GitLab CI/CD Integration Guide with Example**
...
- [kubescape/kubescape#2278](https://github.com/kubescape/kubescape/pull/2278) — **Jenkins CI/CD Integration Guide with Jenkinsfile Example**
...
- [kubescape/kubescape#2219](https://github.com/kubescape/kubescape/pull/2219) — **Dependabot Configuration for GitHub Actions Ecosystem**
...
- [kubescape/kubescape#76](https://github.com/kubescape/kubescape/pull/76) — **Pin Mutable Action Tags to Full Commit SHAs**
...
- [kubescape/kubescape#1991](https://github.com/kubescape/kubescape/pull/1991) — **Clarify Helm vs Kustomize Detection Documentation**
...
- [grafana/loki#21673](https://github.com/grafana/loki/pull/21673) — **Clarify Duration Field Types and Supported Unit Fixes**
...
- [grafana/loki#21705](https://github.com/grafana/loki/pull/21705) — **Fix Default Architecture in Docker Driver Install Command**
...
1. **Use projects like a real user** — Experience their friction points firsthand
2. **Self-identify gaps** — What's broken, unclear, or undocumented? What confused me?
3. **Verify before fixing** — Read source code, confirm I understand the problem correctly
4. **Create quality solutions** — Clear documentation with examples, working code, thoughtful communication
5. **Engage respectfully** — Collaborate with maintainers, address all feedback gracefully

This approach finds issues that genuinely matter to users, not just what's listed in issue trackers.

**Concrete example:** I noticed Kubescape had GitHub Actions integration docs but no Jenkins or GitLab examples. I added both. Not from an issue tracker—from observing real users trying to use Kubescape in their CI/CD pipelines.

---

## 🎓 Projects

### [DevOps CI/CD Pipeline on AWS](https://github.com/ivaresarthak-cloud/devops-ci-cd-pipeline-aws)

**End-to-End Jenkins → Docker → Kubernetes → Minikube Pipeline on AWS EC2**
...
### [DevOps Monitoring Stack](https://github.com/ivaresarthak-cloud/devops-monitoring-project)

**Production-Grade Monitoring: Prometheus → Grafana → DefectDojo**
...
- ✅ DevOps discussions & technical deep-dives
